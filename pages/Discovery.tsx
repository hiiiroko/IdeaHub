      ...
      <div className="sticky top-0 z-30 bg-bg/95 backdrop-blur-sm py-4 mb-6 -mx-6 px-6 border-b border-gray-200/50 space-y-4 md:space-y-0 md:flex md:items-center md:justify-between gap-4">
        ...
        <div className="flex items-center gap-3 overflow-x-auto pb-2 md:pb-0 scrollbar-hide">
          ...
          <div 
            ...
            className="relative flex bg-white rounded-lg p-1 border border-gray-200"
          >
            {/* 动态高亮背景 */}
            <div 
              className="absolute bg-blue-50 pointer-events-none" 
      ...
      {isLoading ? (
        <div className="columns-2 md:columns-3 lg:columns-4 gap-4 space-y-4">
          {Array.from({ length: 8 }).map((_, i) => (
            <div key={i} className="break-inside-avoid bg-white rounded-xl overflow-hidden border border-gray-200 h-64 animate-pulse">
